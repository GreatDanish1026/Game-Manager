...
export default function Sidebar({
  ...
  const [
    renamingSavedViewId,
    setRenamingSavedViewId,
  ] =
    useState(null);

  const [
    renamingSavedViewName,
    setRenamingSavedViewName,
  ] =
    useState("");
  ...
  function commitRenameSavedView(
    viewId
  ) {
    const view =
      savedViews.find(
    ...
    if (!name) {
      setSavedViewMessage(
        "Saved View names cannot be blank."
      );
